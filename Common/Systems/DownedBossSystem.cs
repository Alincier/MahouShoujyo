...
namespace MahouShoujyo.Common.Systems
{
	...
	{
		public static bool downedConciousBoss = false;
		// public static bool downedOtherBoss = false;

		public override void ClearWorld() {
            downedConciousBoss = false;
		...
		public override void SaveWorldData(TagCompound tag) {
			if (downedConciousBoss) {
				tag["downedConciousBoss"] = true;
			}
		...
		public override void LoadWorldData(TagCompound tag) {
            downedConciousBoss = tag.ContainsKey("downedConciousBoss");
		...
		public override void NetSend(BinaryWriter writer) {
			...
			*/
            ...
            // BitsByte flags = new BitsByte(downedConciousBoss, downedOtherBoss);
            // writer.Write(flags);
