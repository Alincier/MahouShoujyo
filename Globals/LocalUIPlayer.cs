...
namespace MahouShoujyo.Globals
{
    internal class LocalUIPlayer : ModPlayer
    {
        ...
        private Texture2D chargebar = ModContent.Request<Texture2D>("MahouShoujyo/Content/Assets/YellowGunBar").Value;
        private Texture2D chargestrip = ModContent.Request<Texture2D>("MahouShoujyo/Content/Assets/YellowGunStrip").Value;
        private Texture2D yellowgun = ModContent.Request<Texture2D>("MahouShoujyo/Content/Assets/YellowGun").Value;
