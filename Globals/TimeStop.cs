    ...
    public class TimeStop : ModPlayer
    {
        ...
        public override void PostUpdate()
        {
            if (!ModContent.GetInstance<ClientConfigs>().FilterClosed_TimeStop && TimeStopSystem.TimeStopping)
            {
                ...
                MahouShoujyo.SceneShader(tech: "GrayScaleTimeStop", degree: 0.5f,factor:0, r0: 32 , r1: radias, r2: 48, targetX: Main.LocalPlayer.Center.X, targetY: Main.LocalPlayer.Center.Y);
                MahouShoujyo.SceneShader(tech: "ShockWaveTechnique", degree: radias / 400f, factor: 100-radias / 12f, r0: 5, r1: 5f, r2: 5, targetX: Main.LocalPlayer.Center.X, targetY: Main.LocalPlayer.Center.Y);
            }
            else
            {
                MahouShoujyo.DelSceneShader("GrayScaleTimeStop");
                MahouShoujyo.DelSceneShader("ShockWaveTechnique");
                timeLast = 0;
        ...
        public override void SyncPlayer(int toWho, int fromWho, bool newPlayer)
        {
            ...
            packet.Write((byte)MahouShoujyo.MessageType.TimeStopSync);
