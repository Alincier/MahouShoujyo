...
namespace MahouShoujyo.Content.Projectiles
{
    ...
    {
        private Texture2D tex = ModContent.Request<Texture2D>("MahouShoujyo/Content/Projectiles/TimeMissile").Value;
        public int runtime = 0;
        public int stage = 0;
        SoundStyle explosion1 = new SoundStyle($"MahouShoujyo/Radio/Sound/explosion1") with { PitchVariance = 0.4f };
