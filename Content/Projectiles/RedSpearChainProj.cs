...
namespace MahouShoujyo.Content.Projectiles
{
    public class RedSpearChainProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] == -2)
            {
                ...
                if (Main.netMode != NetmodeID.Server)
                    SoundEngine.PlaySound(new SoundStyle($"MahouShoujyo/Radio/Sound/chains"), Projectile.Center, soundInstance =>
                    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D tex = ModContent.Request<Texture2D>("MahouShoujyo/Content/Projectiles/RedSpearChainProj").Value;
            int width = tex.Width;
