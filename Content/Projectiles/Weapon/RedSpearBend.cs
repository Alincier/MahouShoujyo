...
namespace MahouShoujyo.Content.Projectiles.Weapon
{
    public class RedSpearBend : ModProjectile
    {
        ...
        Vector2[] pos_old;
        Vector2[] vel_old;
        private Texture2D tex = ModContent.Request<Texture2D>("MahouShoujyo/Content/Projectiles/Weapon/RedSpearBend").Value;
        ...
        public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
        {
            ...
            if (count>=16) modifiers.FinalDamage*=0.5f;
            else if (count>=8) modifiers.FinalDamage*=0.6f;
            else if (count>=4) modifiers.FinalDamage*=0.7f;
            else if (count>=2) modifiers.FinalDamage*=0.8f;
