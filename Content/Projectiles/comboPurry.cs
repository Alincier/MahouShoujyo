...
namespace MahouShoujyo.Content.Projectiles
{
    public class comboPurry : ModProjectile
    {
        ...
        SoundStyle hited = new SoundStyle($"MahouShoujyo/Radio/Sound/immune")
        {
        ...
        public override void AI()
        {
            ...
            //MahouShoujyo.push((Projectile.timeLeft<=120)?Vector2.Zero:root*scale+Projectile.velocity*scale, Projectile.velocity*length, frame_tail, ref pos_old, ref vel_old);
        }
