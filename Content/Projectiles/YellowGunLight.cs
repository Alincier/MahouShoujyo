...
namespace MahouShoujyo.Content.Projectiles
{
    ...
    {
        private Texture2D tex = ModContent.Request<Texture2D>("MahouShoujyo/Content/Projectiles/YellowGunLight").Value;
        private Texture2D yellowguncannon = ModContent.Request<Texture2D>("MahouShoujyo/Content/Assets/YellowGunCannon").Value;
        private Texture2D cannonlight = ModContent.Request<Texture2D>("MahouShoujyo/Content/Assets/YellowCannonLight").Value;
        private SoundStyle magical = new SoundStyle($"MahouShoujyo/Radio/Sound/magical");
        private SoundStyle electriccharged = new SoundStyle($"MahouShoujyo/Radio/Sound/ElectricCharged") with { MaxInstances=1, SoundLimitBehavior=SoundLimitBehavior.ReplaceOldest};
        private SoundStyle simpleshoot = new SoundStyle($"MahouShoujyo/Radio/Sound/SimpleElectricShoot") with { MaxInstances=1, SoundLimitBehavior=SoundLimitBehavior.ReplaceOldest };
        private SoundStyle heavyshoot = new SoundStyle($"MahouShoujyo/Radio/Sound/HeavyElectricShoot") with { MaxInstances=1, SoundLimitBehavior=SoundLimitBehavior.ReplaceOldest,Volume = 0.5f};
