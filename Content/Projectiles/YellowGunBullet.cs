...
namespace MahouShoujyo.Content.Projectiles
{
    ...
    {
        //材质
        private Texture2D tex_gun = ModContent.Request<Texture2D>("MahouShoujyo/Content/Projectiles/YellowGun").Value;
        private Texture2D tex = ModContent.Request<Texture2D>("MahouShoujyo/Content/Projectiles/YellowGunBullet").Value;
        bool initial = true;
        bool copy = false;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (ve.Count >= 3)
            {
                gd.Textures[0] = ModContent.Request<Texture2D>("MahouShoujyo/Content/Assets/YellowGunBullet").Value;//获取刀光的拖尾贴图
