...
namespace MahouShoujyo.Content.Projectiles
{
    ...
    {
        private Texture2D tex = ModContent.Request<Texture2D>("MahouShoujyo/Content/Projectiles/explosion1").Value;
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            sb.Draw(
                ...
                rect, lightColor,Projectile.velocity.ToRotation()- MathHelper.ToRadians(90f),
