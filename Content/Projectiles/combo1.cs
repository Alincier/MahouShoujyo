...
{
    public class combo1 : ModProjectile
    {
        ...
        {
            Projectile.width = 144; // The width of projectile hitbox
            Projectile.height = 96; // The height of projectile hitbox
            ...
            //离中心点的手柄位置,剑身长度为64像素
            root0=new Vector2[2] { new Vector2(16f, 16f), new Vector2(-16f, 16f) };
            rotation0 =new float[2] { MathHelper.ToRadians(45f), MathHelper.ToRadians(-225f) };
            length0 = 0.8f;
            root1 =new Vector2[2] { new Vector2(16f, 0f), new Vector2(-16f, 0f) };
            rotation1 =new float[2] { MathHelper.ToRadians(-60f), MathHelper.ToRadians(-120f) };
            length1 = 0.8f;
            root2 = new Vector2[2] { new Vector2(-16f, 16f), new Vector2(16f, 16f) };
            rotation2 =new float[2] { MathHelper.ToRadians(-225f), MathHelper.ToRadians(45f) };
            length2 = 1f;
            //阶段帧数
            period1 = 30;
            period2 = 50;
        ...
        public override void AI()
        {
            ...
            Vector2 position = Main.player[Projectile.owner].Center+new Vector2(0f*scale*(direction*2-1), -20f*scale);
