...
{
    public class MusicBox_Magia : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Radio/Music/Madoka4"), ModContent.ItemType<MusicBox_Magia>(), ModContent.TileType<MusicBox_Magia_Tile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<MusicBox_Magia_Tile>(), 0);
        }
    }
}
