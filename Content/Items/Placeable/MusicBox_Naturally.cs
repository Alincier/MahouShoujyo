...
{
    public class MusicBox_Naturally : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Radio/Music/Naturally"), ModContent.ItemType<MusicBox_Naturally>(), ModContent.TileType<MusicBox_Naturally_Tile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<MusicBox_Naturally_Tile>(), 0);
        }
    }
}
