...
{
    public class MusicBox_Decretum : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Radio/Music/Madoka5"), ModContent.ItemType<MusicBox_Decretum>(), ModContent.TileType<MusicBox_Decretum_Tile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<MusicBox_Decretum_Tile>(), 0);
        }
    }
}
