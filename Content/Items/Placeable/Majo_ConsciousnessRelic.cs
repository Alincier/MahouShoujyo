using MahouShoujyo.Content.Tiles.Placeable.Relics;
using Terraria;
using Terraria.ID;
...
{
	public class Majo_ConsciousnessRelic : ModItem
	{
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<ConsciousnessRelic>(), 0);
