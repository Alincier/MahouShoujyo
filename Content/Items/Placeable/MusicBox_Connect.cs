...
{
    public class MusicBox_Connect : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Radio/Music/Madoka1"), ModContent.ItemType<MusicBox_Connect>(), ModContent.TileType<MusicBox_Connect_Tile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<MusicBox_Connect_Tile>(), 0);
        }
    }
}
