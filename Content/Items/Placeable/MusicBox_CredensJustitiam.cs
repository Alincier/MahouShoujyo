...
{
    public class MusicBox_CredensJustitiam : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Radio/Music/CredensJustitiam"), ModContent.ItemType<MusicBox_CredensJustitiam>(), ModContent.TileType<MusicBox_CredensJustitiam_Tile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<MusicBox_CredensJustitiam_Tile>(), 0);
        }
    }
}
