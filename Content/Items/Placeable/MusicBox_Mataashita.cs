...
{
    public class MusicBox_Mataashita : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Radio/Music/Madoka2"), ModContent.ItemType<MusicBox_Mataashita>(), ModContent.TileType<MusicBox_Mataashita_Tile>());
        }

        public override void SetDefaults()
        {
            Item.DefaultToMusicBox(ModContent.TileType<MusicBox_Mataashita_Tile>(), 0);
        }
    }
}
