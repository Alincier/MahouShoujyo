...
namespace MahouShoujyo.Content.Items.Consumables.BOSS_Summon
{
    ...
    public class DespairSoul : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            return !NPC.AnyNPCs(ModContent.NPCType<Majo_Consciousness>());
        }
