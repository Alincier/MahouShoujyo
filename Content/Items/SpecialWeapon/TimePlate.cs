...
namespace MahouShoujyo.Content.Items.SpecialWeapon;
...
public class TimePlate : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.useTime = 20;
        Item.UseSound = new SoundStyle($"MahouShoujyo/Radio/Sound/clocksound");
    ...
    public override void UpdateAccessory(Player player, bool hideVisual)
    {
        ...
        if (Main.netMode == NetmodeID.MultiplayerClient)
        {
            ...
            packet.Write((byte)MahouShoujyo.MessageType.TimeStopSubmit);
