...
namespace MahouShoujyo.Content.Tiles.MusicBox
{
    public class MusicBox_CredensJustitiam_Tile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            player.cursorItemIconID = ModContent.ItemType<MusicBox_CredensJustitiam>();
        }
