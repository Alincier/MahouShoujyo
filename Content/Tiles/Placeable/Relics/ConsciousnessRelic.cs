...
namespace MahouShoujyo.Content.Tiles.Placeable.Relics
{
	...
	public class ConsciousnessRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "MahouShoujyo/Content/Tiles/Placeable/Relics/ConsciousnessRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "MahouShoujyo/Content/Tiles/Placeable/Relics/RelicPedestal";
