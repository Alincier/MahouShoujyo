...
using MahouShoujyo.Content.Items.Consumables;
using MahouShoujyo.Common.ItemDropRules;
using MahouShoujyo.Content.Items.Consumables.StatIncreaseItem;
...
namespace MahouShoujyo.Content.NPCs.BOSSes.Majo_Consciousness
{
    [AutoloadBossHead]
    public class Majo_Consciousness : ModNPC
    {
        ...
        private Texture2D texorigin = ModContent.Request<Texture2D>("MahouShoujyo/Content/NPCs/BOSSes/Majo_Consciousness/Majo_Consciousness").Value;
       // private Texture2D texeye = ModContent.Request<Texture2D>("MahouShoujyo/Content/NPCs/BOSSes/Majo_Consciousness/Majo_Consciousness_Eye").Value;
        private Texture2D texeyeball = ModContent.Request<Texture2D>("MahouShoujyo/Content/NPCs/BOSSes/Majo_Consciousness/Majo_Consciousness_EyeBall").Value;
        private Texture2D beauty = ModContent.Request<Texture2D>("MahouShoujyo/Content/NPCs/BOSSes/Majo_Consciousness/Majo_Consciousness_Beauty").Value;
        int bonus =1;//难度加成系数
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "MahouShoujyo/Content/NPCs/BOSSes/Majo_Consciousness/Majo_Consciousness_Preview",
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            if (!ModContent.GetInstance<ClientConfigs>().GrayScaleClosed_Consciousness && NPC.life>stagepoint)
                MahouShoujyo.SceneShader("GrayScaleMajoConciousness", 0.7f*(float)Math.Max(0, NPC.life-stagepoint) / (float)(NPC.lifeMax-stagepoint));
            else MahouShoujyo.DelSceneShader("GrayScaleMajoConciousness");
        ...
        public override void AI()
        {
            ...
            if (player.dead)
            {
                ...
                MahouShoujyo.DelSceneShader("GrayScaleMajoConciousness");
