...
namespace MahouShoujyo.Content.Assets.Backgrounds
{
    public class ConsciousBackgroundStyle : ModSurfaceBackgroundStyle
    {
        ...
        int tex0;// = ModContent.Request<Texture2D>("MahouShoujyo/Content/Assets/Backgrounds/ConsciousBackgroundStyle0").Value;
        int tex1;// = ModContent.Request<Texture2D>("MahouShoujyo/Content/Assets/Backgrounds/ConsciousBackgroundStyle1").Value;
